...
function initializeChapterSelect() {
  ...
  // Ajouter des options si elles n'existent pas encore
  if (selectMenu.options.length === 0) {
      for (let i = 33; i >= 25; i--) {
          ...
          option.dataset.redirect = `https://lanortrad.netlify.app/tougen%20anki/tome%2004/chapitre%20${formattedNumber}`;
