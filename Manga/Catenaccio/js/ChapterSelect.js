const totalChapters = 36; // Nombre total de chapitres

// Liste complète des chapitres disponibles pour Catenaccio
const chaptersList = Array.from({ length: 36 }, (_, i) => i + 1);

// ===== TRACKING AUTOMATIQUE =====
/**
 * Extrait le nom du manga et le numéro du chapitre depuis l'URL
 * Exemple: "/Manga/Catenaccio/Chapitre 1.html" → { mangaId: "Catenaccio", chapterId: "chapitre-1" }
 */
