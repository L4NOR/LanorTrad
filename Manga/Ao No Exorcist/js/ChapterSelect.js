const totalChapters = 164; // Nombre total de chapitres

// Liste complète des chapitres disponibles pour Ao No Exorcist
const chaptersList = Array.from({ length: 164 }, (_, i) => i + 1);

// ===== TRACKING AUTOMATIQUE =====
/**
 * Extrait le nom du manga et le numéro du chapitre depuis l'URL
 * Exemple: "/Manga/Ao No Exorcist/Chapitre 1.html" → { mangaId: "Ao No Exorcist", chapterId: "chapitre-1" }
 */
...
function changeChapter(direction) {
    ...
    if (newIndex < 0) {
        ...
        alert("Il n'y a pas de chapitre suivant actuellement. Prochain chapitre pour le 3 Avril !");
        return;
    }
