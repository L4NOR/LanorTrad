document.addEventListener('DOMContentLoaded', function() {
    ...
    let isChapitresVisible = false; // Afficher les tomes par défaut
        ...
        for (let i = start; i < end; i++) {
            ...
            html += `
                <div class="chapter-card">
                    <a href="tokyo underworld/Chapitre%20${chapitreNumber}.html" class="tome-link">
                        <img src="images/TU/cover.jpg" alt="Couverture du chapitre ${chapitreNumber}">
    ...
    function createTomesSection() {
        ...
        for (let i = start; i < end; i++) {
            ...
            const link = `tokyo underworld/Tome ${formattedNumber}.html`;
            
            html += `
                <div class="tome-card">
                    <a href="${link}" class="tome-link">
                        <img src="images/TU/T${formattedNumber}.jpg" alt="Couverture du tome ${formattedNumber}">
    ...
    function changePage(direction) {
        const totalItems = isChapitresVisible ? 8 : 3; // Nombre total de chapitres ou de tomes
        const totalPages = Math.ceil(totalItems / itemsPerPage);
