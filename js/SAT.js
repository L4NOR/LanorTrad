document.addEventListener('DOMContentLoaded', function() {
    ...
    function createChapitresSection() {
        const chapitres = [11, 10, 9, 8, 7]; // Liste des chapitres disponibles
        ...
        for (let i = start; i < end; i++) {
            ...
            html += `
                <div class="chapter-card">
                    <a href="satsudou/Chapitre%20${chapitreNumber}.html" class="tome-link">
    ...
    function createTomesSection() {
        const totalTomes = 1; // Nombre total de tomes
        const start = (currentPage - 1) * itemsPerPage;
        ...
        for (let i = start; i < end; i++) {
            ...
            const link = `satsudou/Tome ${formattedNumber}.html`;
